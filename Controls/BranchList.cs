...
public void Initialize(CommitHistory commitHistory)
{
...
private string[] FilterBranch(string[] cmdResult)
{
...
private void Branch_Menu_ItemClicked(object sender, ToolStripItemClickedEventArgs e)
{
...
private void GraphRefresh(string path)
{
...
private void BranchCommand(string path, string command, string branch)
{
    ProcessStartInfo cmd = new ProcessStartInfo();
    Process process = new Process();
    cmd.FileName = @"cmd";
